...
function MainView() {
    ...
    const weixinLayerImage = () => (isWeiXin() ? <img className=" absolute top-0" src="//files.revome.cn/public/e52dd5fb483c45299d9bb24507ac3f7f_wexinweblayer.png"></img> : <div className=" h-0 w-0"></div>)
    return (
